          ...
          <div className="glass" style={{ padding: 32, marginBottom: 24 }}>
            ...
            {activeTab === 'graph' && (
              <div className="glass" style={{ padding: 32 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: 24, marginTop: 16, flexWrap: 'wrap' }}>
                  {[
                    ...
                    <div key={label} style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                      ...
                      <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 11, color: 'rgba(167,139,250,0.6)', letterSpacing: '0.05em' }}>
                        {label}
                      </span>
                    </div>
                  ))}
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <div style={{ width: 10, height: 10, borderRadius: '50%', background: 'rgba(167,139,250,0.22)', border: '1px solid rgba(167,139,250,0.3)' }} />
                    <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 11, color: 'rgba(167,139,250,0.6)', letterSpacing: '0.05em' }}>
                      Inactive
                    </span>
                  </div>
                ...
                <div style={{ marginTop: 28, borderTop: '1px solid rgba(167,139,250,0.1)', paddingTop: 24 }}>
                  <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 11, letterSpacing: '0.12em', color: 'rgba(167,139,250,0.4)', textTransform: 'uppercase', marginBottom: 14, textAlign: 'center' }}>
                    Centers
                  </p>
                    ...
                    {ALL_CENTER_NAMES.map(center => {
                      ...
                      return (
                        <div key={center} style={{
                          ...
                          background: isDefined ? 'rgba(109,40,217,0.25)' : 'rgba(22,14,60,0.5)',
                          border: `1px solid ${isDefined ? 'rgba(167,139,250,0.4)' : 'rgba(167,139,250,0.12)'}`,
                        }}>
                          <div style={{
                            width: 7, height: 7, borderRadius: '50%', flexShrink: 0,
                            background: isDefined ? '#A78BFA' : 'transparent',
                            border: isDefined ? 'none' : '1px solid rgba(167,139,250,0.3)',
                          }} />
                          <span style={{
                            fontFamily: 'Cinzel, serif', fontSize: 11,
                            color: isDefined ? '#C4B5FD' : 'rgba(167,139,250,0.4)',
                            letterSpacing: '0.04em',
                          }}>
                            {displayName}
                          </span>
